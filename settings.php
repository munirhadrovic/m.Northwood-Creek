<?php
	$adresa="8910 Northwood Creek Drive North Little Rock,AR 72113"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=5013527777;// Broj koji se poziva na dugme CALL US
